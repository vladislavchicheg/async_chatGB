...
from common.variables import DATA_BASES_PATH, CLIENT_DATABASE_NAME
...
class ClientDatabase:
    ...
    def __init__(self, name):
        ...
        self.database_path = Path(__file__).resolve().parents[3].joinpath(DATA_BASES_PATH).joinpath(
            CLIENT_DATABASE_NAME)
        self.database_engine = create_engine(f'sqlite:///{self.database_path}_{name}.sqlite', echo=False,
